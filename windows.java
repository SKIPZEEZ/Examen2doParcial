...
public class windows  extends JFrame{
	...
	public windows() {
		...
		this.getContentPane().setBackground(Color.decode("#49E6A4"));
		...
		this.route();
				...
				JMenuItem jmi5 = new JMenuItem("¿Como crear un Usuario? ");
				jm3.add(jmi5);
	...
	public JPanel splash() {
		...
		splash.setBackground(Color.decode("#49E6A4"));
		...
		JLabel tag1 = new JLabel("Power by Angel Guzman and Tristan Canett ");
		...
		JButton jbnAcceso = new JButton("Acceder");
		jbnAcceso.setSize(380,30);
		jbnAcceso.setLocation(100, 450);
		splash.add(jbnAcceso);
		
		jbnAcceso.addActionListener(new ActionListener() {
	...
	public JPanel login() {
		...
		login.setBackground(Color.decode("#49E6A4"));
		...
		JLabel tag4 = new JLabel("Power by Angel Guzman and Tristan Canett ");
	...
	public JPanel registro() {
		...
		registro.setBackground(Color.decode("#49E6A4"));
		...
		JButton saveUsr = new JButton("Guardar");
	...
	public JPanel bienvenido () {
		...
		bienvenido.setBackground(Color.decode("#49E6A4"));
		...
		JButton saveUsr = new JButton("continuar");
		saveUsr.setSize(380, 35);
		saveUsr.setLocation(100,500);
		saveUsr.setBackground(Color.white);
	...
	public JPanel cuentapersonal () {
		...
		cuentapersonal.setBackground(Color.decode("#49E6A4"));
		cuentapersonal.setLayout(null);
	
		
		JLabel tag1 = new JLabel("Mi Cuenta", JLabel.CENTER);
		tag1.setFont(new Font("Comic Sans",Font.BOLD,23));
		tag1.setSize(400, 20);
		tag1.setLocation(100, 30);
		tag1.setOpaque(true);
		tag1.setBackground(Color.white);
		...
		JButton saveUsr = new JButton("Cancelar");
		...
		JButton saveUsr1 = new JButton("Actualizar");
	...
	public  JPanel listausuarios() {
		...
		listausuarios.setBackground(Color.decode("#49E6A4"));
		...
		JButton saveUsr = new JButton("Ingresar");
	...
	public  JPanel crearusuario () {
		...
		crearusuario.setBackground(Color.RED);
		...
		JButton saveUsr1 = new JButton("Crear");
		saveUsr1.setSize(200, 35);
		saveUsr1.setLocation(300,500);
		saveUsr1.setBackground(Color.white);
	...
	public JPanel crear () {
		...
		crear.setBackground(Color.decode("#49E6A4"));
		...
		crear.add(im6);
		 ...
		 JLabel tag2 = new JLabel("1 haga click en la opcion usuarios en el menu superior ");
			...
			JButton saveUsr = new JButton("Crear");
			saveUsr.setSize(380, 35);
			saveUsr.setLocation(100,500);
			saveUsr.setBackground(Color.white);
			crear.add(saveUsr);
